...
The technicalOutlook field contains calculated indicators and conditional scenario
ranges generated by the app. Treat these as technical context only. Do not describe
scenario ranges as predictions, do not invent targets beyond the provided ranges,
and do not imply that a bull/base/bear scenario is guaranteed. Mention confidence
level and invalidation level when available.
...
- Treat technical scenarios as conditional ranges, not deterministic price forecasts.
- Do not invent technical targets beyond the calculated scenario ranges.
